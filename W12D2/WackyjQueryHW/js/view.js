...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  $("script").after("<h1>I love jquery</h1>")
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  // const test= $("li").data("pos")
  $("li:nth-child(even)").text("Carlos");
};
...
View.prototype.exercise7 = function(){
  ...
  $('.square').on("mouseenter", (ele) => {
    const $ele = $(ele.currentTarget)
