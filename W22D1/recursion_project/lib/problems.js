...
function reverseString(str) {
 ...
 let merged = array.join("")
 return letter + reverseString(merged)
}
...
function fileFinder(directories, targetFile) {
    // let objects = Object.keys(directories)

    // if (objects.includes(targetFile)){
    //     return true
    // }
    ...
    //         // console.log(obj)
    //         let innerDirectory = directories[obj]
    //         // console.log(innerDirectory)
    //         return fileFinder(innerDirectory, targetFile)
    //     } 
    ...
    //         // console.log(obj)
    //         let innerDirectory = directories[element]
    //         // console.log(innerDirectory)
    //         return fileFinder(innerDirectory, targetFile)
    //     } 
